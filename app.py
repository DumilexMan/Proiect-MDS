...
@app.route('/posts_filter_by_price')
def posts_filter_by_price():
    ok=0
...
def auctions_with_status_open_with_current_price_between():
    ok=0
    price1 = request.args.get('lower_price')
    price2 = request.args.get('upper_price')
    if price1 > price2:
